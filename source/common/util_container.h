...
public:
	...
	my_list(my_list<node_ty> &&other)
	{
		if (other.m_size != 0) {
			head_node.pre = nullptr;
			tail_node.next = nullptr;

			head_node.next = other.head_node.next;
			head_node.next->pre = &head_node;
			tail_node.pre = other.tail_node.pre;
			tail_node.pre->next = &tail_node;

			other.head_node.next = &(other.tail_node);
			other.tail_node.pre = &(other.head_node);

			m_size = other.m_size;
			other.m_size = 0;
		}
	}
	my_list(my_list<node_ty> &other) = delete;
	~my_list()
	{
